...
- **The core data-foundation/auth/canonical-cockpit line is integrated into `main`.** PRs #30, #31, #33, #35, #60, #61, #62, #73, and #74 have merged. After PR #74, the exact `main` SHA is `c46ab6ed1f2766ed7a5a16aa8dd01655f1a936fe`.
...
- The canonical offline cockpit / identity / leakage-safe enrichment work is now integrated through PR #74. The superseded stacked PRs #32, #34, #36–#59, #71, #72, and #75 have been closed after ancestry/content verification. The maintenance-scope regression guard is now isolated in current-main PR #76 and is not yet merged at this snapshot.
